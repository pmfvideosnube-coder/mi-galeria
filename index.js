  ...
  try {
    ...
    let html = `
      ...
      <head>
        ...
        <style>
          :root {
            --pastel-bg: #f6f9fb;      /* azul pastel */
            --pastel-card: #ffffff;   /* blanco */
            --pastel-border: #d1d9e6; /* gris pastel */
            --pastel-title: #6a4c93;  /* lila pastel */
            --pastel-subtitle: #4a6fa5; /* azul pastel */
            --pastel-text: #777777;   /* gris suave */
          }
